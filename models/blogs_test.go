...
var (
	blogDBTypes = map[string]string{`ID`: `integer`, `Slug`: `character varying`, `Title`: `character varying`, `Abstract`: `character varying`, `Content`: `text`, `UserID`: `character varying`, `IsPublic`: `boolean`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
