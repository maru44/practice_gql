...
var BlogWhere = struct {
	...
	Slug:      whereHelperstring{field: "\"blogs\".\"slug\""},
	Title:     whereHelperstring{field: "\"blogs\".\"title\""},
	Abstract:  whereHelpernull_String{field: "\"blogs\".\"abstract\""},
	Content:   whereHelperstring{field: "\"blogs\".\"content\""},
	UserID:    whereHelperstring{field: "\"blogs\".\"user_id\""},
	IsPublic:  whereHelperbool{field: "\"blogs\".\"is_public\""},
	CreatedAt: whereHelpernull_Time{field: "\"blogs\".\"created_at\""},
	UpdatedAt: whereHelpernull_Time{field: "\"blogs\".\"updated_at\""},
}
...
var (
	blogAllColumns            = []string{"id", "slug", "title", "abstract", "content", "user_id", "is_public", "created_at", "updated_at"}
	blogColumnsWithoutDefault = []string{"slug", "title", "abstract", "content", "user_id"}
	blogColumnsWithDefault    = []string{"id", "is_public", "created_at", "updated_at"}
